// Dán (copy-paste) nội dung lịch học, lịch khai giảng của bạn vào đây.
// Bạn có thể giữ nguyên định dạng từ file Word, Excel, hoặc văn bản của bạn.
// Chatbot sẽ đọc và tóm tắt thông tin này cho người dùng.
...
=======
`;
>>>>>>> 0f5881b (Initial commit with project files)
